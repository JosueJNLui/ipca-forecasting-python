...
class WebBot:
    ...
    def get_reports(self):
        xpath_elements = {
            "from_2001_to_2012": [
                '//*[@id="parent-fieldname-text"]/ul[2]/li[1]/a',
                '//*[@id="parent-fieldname-text"]/ul[2]/li[1]/div/ul/li[1]/a',
            ],
            "from_2013": [
                '//*[@id="parent-fieldname-text"]/ul[2]/li[2]/a',
                '//*[@id="parent-fieldname-text"]/ul[2]/li[2]/div/ul/li[1]/a',
            ],
        }
        ...
        for label, elements in xpath_elements.items():
            ...
            if driver.find_element(By.XPATH, "/html/body/div[5]/div"):
                driver.find_element(
                    By.XPATH, "/html/body/div[5]/div/div/div/div/div[2]/button[2]"
                ).click()
            ...
            raw_file_path = os.path.join(
                self.download_folder_path, os.listdir(self.download_folder_path)[0]
            )
    ...
    def extract_data(excel_path: str, destiny_folder: str, filename: str):
        ...
        header = {
            cell.column: Utils.process_text(cell.value)
            for cell in ws[start_row]
            if cell.value
        }

        for row in ws.iter_rows(start_row + 1, ws.max_row, ws.min_column, len(header)):
            row_values = {}
