...
class Model:
    ...
    def __init__(self, df: pl.DataFrame, test_portion: float, target_col: str, results_path: str) -> None:
        self.X_train, self.y_train, self.X_test, self.y_test = self.train_test_split(df, test_portion, target_col)
...
HISTORICAL_DATA = '/home/josue-lui/dev/ipca-forecasting-python/data/historical_data.json'
